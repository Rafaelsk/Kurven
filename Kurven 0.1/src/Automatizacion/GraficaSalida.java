 ...
 * @author rafael
 */
public class GraficaSalida extends javax.swing.JPanel {

    /**
     * Creates new form GraficaDatos
     */
    public GraficaSalida() {
        initComponents();
        graficarSalida=false;
    ...
    public void paintComponent(Graphics g)
    {
        ...
        Color colorSalida = Color.YELLOW;
    ...
    public void setPuntosSalida(ArrayList<Punto> puntos)
    {
        this.puntosSalida = new Punto[puntos.size()];
        puntos.toArray(this.puntosSalida);
        
        float indiceXD = puntosSalida[puntosSalida.length-1].getX()+2;
            float indiceYD = puntosSalida[puntosSalida.length-1].getY()+1;
    ...
    private boolean graficarSalida;

    private Punto[] puntosSalida;
